...
module.exports = "ion-input, ion-item-divider {\n  background-color: #1ad7f0;\n  margin: 3px 0; }\n\nion-item-divider {\n  border-radius: 15px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
    ...
    PredictionFormPage.prototype.predict = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                url = './prediction';
                try {
                    params = "?age=" + this.AgeValue + "&bmi=" + this.BMIValue + "&st=" + this.STValue + "&ins=" + this.InsValue + "&dpf=" + this.DPFValue + "&glu=" + this.GluValue + "&preg=" + this.PregValue + "&bp=" + this.BPValue;
                    url = url + params;
                }
                catch (err) {
                    console.dir(err);
